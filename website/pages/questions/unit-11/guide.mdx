...
#### Sequences vs functions - convergence [#seqfun1]
...
*   Question 3 is an “obvious” claim. However, when it becomes necessary to use this implication in the middle of a proof, a fraction of students doubt it (and I do not know why). For example, see [“Is this proof correct?”](#recurrence) in recurrence: some student think the error is equating $\displaystyle \lim R_{n}$ and $\displaystyle \lim R_{n+1}$. Thus, it may be good to make them think about this implication in isolation.
...
#### Definition of limit of a sequence [#deflimit]
...
*   Students find 1 and 2 easy – they are similar to [“Sequences vs functions - convergence”.](#seqfun1)
...
#### Limits of sequences defined by recurrence [#recurrence]
...
This is more subtle than it seems. To make sure students got the point, I like to ask them 
“What have we actually proven in \[Slide 2]?” I want them to say “The sequence
$R_{n}$
is either divergent or convergent to
$-1+\sqrt{3}$” but this won’t come out naturally. 
Many won’t see anything wrong or will believe that there is an error in the algebra. Others, noticing we have assumed the sequence is convergent, will believe we have proven nothing.
...
<QuestionPreview question={16} unit={11} small={true} />
...
*   Question 5: The definition of “almost all” appears in [Definition of limit of a sequence](#deflimit).
